...
from luna.chitchat.model import ChitChat
from luna.chitchat.data_loader import ChitChatDataModule
...
class ChitChatSystem(pl.LightningModule):
  ...
  def forward(self, input_ids, token_type_ids, labels=None):
    return self.chitchat(input_ids=input_ids, token_type_ids=token_type_ids, labels=labels)
